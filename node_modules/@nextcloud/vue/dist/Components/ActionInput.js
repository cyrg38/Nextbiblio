 ...
 * along with this program. If not, see <http://www.gnu.org/licenses/>.
 *
 */var m={data:function(){return{hasStatus:!1,userStatus:{status:null,message:null,icon:null}}},methods:{fetchUserStatus:function(t){var n,e=this;return(n=regeneratorRuntime.mark((function n(){var o,a,i,A,r,u,m,p,g;return regeneratorRuntime.wrap((function(n){for(;;)switch(n.prev=n.next){case 0:if(o=Object(c.getCapabilities)(),Object.prototype.hasOwnProperty.call(o,"user_status")&&o.user_status.enabled){n.next=3;break}return n.abrupt("return");case 3:if(Object(d.getCurrentUser)()){n.next=5;break}return n.abrupt("return");case 5:return n.prev=5,n.next=8,s.a.get(Object(l.generateOcsUrl)("apps/user_status/api/v1",2)+"statuses/".concat(encodeURIComponent(t)));case 8:a=n.sent,i=a.data,A=i.ocs.data,r=A.status,u=A.message,m=A.icon,e.userStatus.status=r,e.userStatus.message=u||"",e.userStatus.icon=m||"",e.hasStatus=!0,n.next=22;break;case 17:if(n.prev=17,n.t0=n.catch(5),404!==n.t0.response.status||0!==(null===(p=n.t0.response.data.ocs)||void 0===p||null===(g=p.data)||void 0===g?void 0:g.length)){n.next=21;break}return n.abrupt("return");case 21:console.error(n.t0);case 22:case"end":return n.stop()}}),n,null,[[5,17]])})),function(){var t=this,e=arguments;return new Promise((function(o,a){var i=n.apply(t,e);function A(t){u(i,o,a,A,r,"next",t)}function r(t){u(i,o,a,A,r,"throw",t)}A(void 0)}))})()}}};
/**
 ...
 * along with this program. If not, see <http://www.gnu.org/licenses/>.
 *
 */n.a=function(t,n){for(var e=[],o=0,a=t.toLowerCase().indexOf(n.toLowerCase(),o),i=0;a>-1&&i<t.length;)o=a+n.length,e.push({start:a,end:o}),a=t.toLowerCase().indexOf(n.toLowerCase(),a+1),i++;return e}},function(t,n){t.exports=require("core-js/modules/es.object.get-own-property-descriptor.js")},function(t,n){t.exports=require("core-js/modules/es.object.get-own-property-descriptors.js")},,function(t,n,e){"use strict";e.r(n);e(15),e(98),e(93),e(24),e(69),e(31),e(51),e(71),e(27),e(72);var o=e(70);function a(t,n){var e=Object.keys(t);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(t);n&&(o=o.filter((function(n){return Object.getOwnPropertyDescriptor(t,n).enumerable}))),e.push.apply(e,o)}return e}function i(t){for(var n=1;n<arguments.length;n++){var e=null!=arguments[n]?arguments[n]:{};n%2?a(Object(e),!0).forEach((function(n){A(t,n,e[n])})):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(e)):a(Object(e)).forEach((function(n){Object.defineProperty(t,n,Object.getOwnPropertyDescriptor(e,n))}))}return t}function A(t,n,e){return n in t?Object.defineProperty(t,n,{value:e,enumerable:!0,configurable:!0,writable:!0}):t[n]=e,t}var r={name:"Highlight",props:{text:{type:String,default:""},search:{type:String,default:""},highlight:{type:Array,default:function(){return[]}}},computed:{ranges:function(){var t=this,n=[];return this.search||0!==this.highlight.length?(n=this.highlight.length>0?this.highlight:Object(o.a)(this.text,this.search),n.reduce((function(n,e){return e.start<t.text.length&&e.end>0&&n.push({start:e.start<0?0:e.start,end:e.end>t.text.length?t.text.length:e.end}),n}),[])):n},chunks:function(){if(0===this.ranges.length)return[{start:0,end:this.text.length,highlight:!1,text:this.text}];for(var t=[],n=0,e=0;n<this.text.length;){var o=this.ranges[e];o.start!==n?(t.push({start:n,end:o.start,highlight:!1,text:this.text.substr(n,o.start-n)}),n=o.start):(t.push(i(i({},o),{},{highlight:!0,text:this.text.substr(o.start,o.end-o.start)})),e++,n=o.end,e>=this.ranges.length&&n<this.text.length&&(t.push({start:n,end:this.text.length,highlight:!1,text:this.text.substr(n,this.text.length-n)}),n=this.text.length))}return t}},render:function(t){return this.ranges.length?t("span",{},this.chunks.map((function(n){return n.highlight?t("strong",{},n.text):n.text}))):t("span",{},this.text)}},s=e(3),l=e(78),c=e.n(l),d=Object(s.a)(r,void 0,void 0,!1,null,null,null);"function"==typeof c.a&&c()(d);var u=d.exports;
/**
 * @copyright Copyright (c) 2020 Raimund Schlüßler <raimund.schluessler@mailbox.org>
 *
 * @author Raimund Schlüßler <raimund.schluessler@mailbox.org>
