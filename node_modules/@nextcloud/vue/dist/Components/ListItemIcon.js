 ...
 * along with this program. If not, see <http://www.gnu.org/licenses/>.
 *
 */n.a=function(t,n){for(var A=[],e=0,i=t.toLowerCase().indexOf(n.toLowerCase(),e),o=0;i>-1&&o<t.length;)e=i+n.length,A.push({start:i,end:e}),i=t.toLowerCase().indexOf(n.toLowerCase(),i+1),o++;return A}},function(t,n){t.exports=require("core-js/modules/es.object.get-own-property-descriptor.js")},function(t,n){t.exports=require("core-js/modules/es.object.get-own-property-descriptors.js")},,function(t,n,A){"use strict";A.r(n);A(15),A(98),A(93),A(24),A(69),A(31),A(51),A(71),A(27),A(72);var e=A(70);function i(t,n){var A=Object.keys(t);if(Object.getOwnPropertySymbols){var e=Object.getOwnPropertySymbols(t);n&&(e=e.filter((function(n){return Object.getOwnPropertyDescriptor(t,n).enumerable}))),A.push.apply(A,e)}return A}function o(t){for(var n=1;n<arguments.length;n++){var A=null!=arguments[n]?arguments[n]:{};n%2?i(Object(A),!0).forEach((function(n){a(t,n,A[n])})):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(A)):i(Object(A)).forEach((function(n){Object.defineProperty(t,n,Object.getOwnPropertyDescriptor(A,n))}))}return t}function a(t,n,A){return n in t?Object.defineProperty(t,n,{value:A,enumerable:!0,configurable:!0,writable:!0}):t[n]=A,t}var r={name:"Highlight",props:{text:{type:String,default:""},search:{type:String,default:""},highlight:{type:Array,default:function(){return[]}}},computed:{ranges:function(){var t=this,n=[];return this.search||0!==this.highlight.length?(n=this.highlight.length>0?this.highlight:Object(e.a)(this.text,this.search),n.reduce((function(n,A){return A.start<t.text.length&&A.end>0&&n.push({start:A.start<0?0:A.start,end:A.end>t.text.length?t.text.length:A.end}),n}),[])):n},chunks:function(){if(0===this.ranges.length)return[{start:0,end:this.text.length,highlight:!1,text:this.text}];for(var t=[],n=0,A=0;n<this.text.length;){var e=this.ranges[A];e.start!==n?(t.push({start:n,end:e.start,highlight:!1,text:this.text.substr(n,e.start-n)}),n=e.start):(t.push(o(o({},e),{},{highlight:!0,text:this.text.substr(e.start,e.end-e.start)})),A++,n=e.end,A>=this.ranges.length&&n<this.text.length&&(t.push({start:n,end:this.text.length,highlight:!1,text:this.text.substr(n,this.text.length-n)}),n=this.text.length))}return t}},render:function(t){return this.ranges.length?t("span",{},this.chunks.map((function(n){return n.highlight?t("strong",{},n.text):n.text}))):t("span",{},this.text)}},s=A(3),c=A(78),l=A.n(c),d=Object(s.a)(r,void 0,void 0,!1,null,null,null);"function"==typeof l.a&&l()(d);var u=d.exports;
/**
 * @copyright Copyright (c) 2020 Raimund Schlüßler <raimund.schluessler@mailbox.org>
 *
 * @author Raimund Schlüßler <raimund.schluessler@mailbox.org>
 ...
 * along with this program. If not, see <http://www.gnu.org/licenses/>.
 *
 */n.default={data:function(){return{isFullscreen:this._isFullscreen()}},beforeMount:function(){window.addEventListener("resize",this._onResize)},beforeDestroy:function(){window.removeEventListener("resize",this._onResize)},methods:{_onResize:function(){this.isFullscreen=this._isFullscreen()},_isFullscreen:function(){return window.outerHeight===screen.height}}}},function(t,n,A){"use strict";A.r(n);A(6),A(26),A(16),A(17),A(18),A(40);var e={name:"PopoverMenuItem",props:{item:{type:Object,required:!0,default:function(){return{key:"nextcloud-link",href:"https://nextcloud.com",icon:"icon-links",text:"Nextcloud"}},validator:function(t){return!t.input||-1!==["text","checkbox"].indexOf(t.input)}}},computed:{key:function(){return this.item.key?this.item.key:Math.round(16*Math.random()*1e6).toString(16)},iconIsUrl:function(){try{return new URL(this.item.icon),!0}catch(t){return!1}}},methods:{action:function(t){this.item.action&&this.item.action(t)}}},i=A(2),o=A.n(i),a=A(53),r={insert:"head",singleton:!1},s=(o()(a.a,r),a.a.locals,A(54)),c={insert:"head",singleton:!1},l=(o()(s.a,c),s.a.locals,A(3)),d={name:"PopoverMenu",components:{PopoverMenuItem:Object(l.a)(e,(function(){var t=this,n=t.$createElement,A=t._self._c||n;return A("li",{staticClass:"popover__menuitem"},[t.item.href?A("a",{staticClass:"focusable",attrs:{href:t.item.href?t.item.href:"#",target:t.item.target?t.item.target:"",download:t.item.download,rel:"noreferrer noopener"},on:{click:t.action}},[t.iconIsUrl?A("img",{attrs:{src:t.item.icon}}):A("span",{class:t.item.icon}),t._v(" "),t.item.text&&t.item.longtext?A("p",[A("strong",{staticClass:"menuitem-text"},[t._v("\n\t\t\t\t"+t._s(t.item.text)+"\n\t\t\t")]),A("br"),t._v(" "),A("span",{staticClass:"menuitem-text-detail"},[t._v("\n\t\t\t\t"+t._s(t.item.longtext)+"\n\t\t\t")])]):t.item.text?A("span",[t._v("\n\t\t\t"+t._s(t.item.text)+"\n\t\t")]):t.item.longtext?A("p",[t._v("\n\t\t\t"+t._s(t.item.longtext)+"\n\t\t")]):t._e()]):t.item.input?A("span",{staticClass:"menuitem",class:{active:t.item.active}},["checkbox"!==t.item.input?A("span",{class:t.item.icon}):t._e(),t._v(" "),"text"===t.item.input?A("form",{class:t.item.input,on:{submit:function(n){return n.preventDefault(),t.item.action(n)}}},[A("input",{attrs:{type:t.item.input,placeholder:t.item.text,required:""},domProps:{value:t.item.value}}),t._v(" "),A("input",{staticClass:"icon-confirm",attrs:{type:"submit",value:""}})]):["checkbox"===t.item.input?A("input",{directives:[{name:"model",rawName:"v-model",value:t.item.model,expression:"item.model"}],class:t.item.input,attrs:{id:t.key,type:"checkbox"},domProps:{checked:Array.isArray(t.item.model)?t._i(t.item.model,null)>-1:t.item.model},on:{change:[function(n){var A=t.item.model,e=n.target,i=!!e.checked;if(Array.isArray(A)){var o=t._i(A,null);e.checked?o<0&&t.$set(t.item,"model",A.concat([null])):o>-1&&t.$set(t.item,"model",A.slice(0,o).concat(A.slice(o+1)))}else t.$set(t.item,"model",i)},t.item.action]}}):"radio"===t.item.input?A("input",{directives:[{name:"model",rawName:"v-model",value:t.item.model,expression:"item.model"}],class:t.item.input,attrs:{id:t.key,type:"radio"},domProps:{checked:t._q(t.item.model,null)},on:{change:[function(n){return t.$set(t.item,"model",null)},t.item.action]}}):A("input",{directives:[{name:"model",rawName:"v-model",value:t.item.model,expression:"item.model"}],class:t.item.input,attrs:{id:t.key,type:t.item.input},domProps:{value:t.item.model},on:{change:t.item.action,input:function(n){n.target.composing||t.$set(t.item,"model",n.target.value)}}}),t._v(" "),A("label",{attrs:{for:t.key},on:{click:function(n){return n.stopPropagation(),n.preventDefault(),t.item.action(n)}}},[t._v("\n\t\t\t\t"+t._s(t.item.text)+"\n\t\t\t")])]],2):t.item.action?A("button",{staticClass:"menuitem focusable",class:{active:t.item.active},attrs:{disabled:t.item.disabled},on:{click:function(n){return n.stopPropagation(),n.preventDefault(),t.item.action(n)}}},[A("span",{class:t.item.icon}),t._v(" "),t.item.text&&t.item.longtext?A("p",[A("strong",{staticClass:"menuitem-text"},[t._v("\n\t\t\t\t"+t._s(t.item.text)+"\n\t\t\t")]),A("br"),t._v(" "),A("span",{staticClass:"menuitem-text-detail"},[t._v("\n\t\t\t\t"+t._s(t.item.longtext)+"\n\t\t\t")])]):t.item.text?A("span",[t._v("\n\t\t\t"+t._s(t.item.text)+"\n\t\t")]):t.item.longtext?A("p",[t._v("\n\t\t\t"+t._s(t.item.longtext)+"\n\t\t")]):t._e()]):A("span",{staticClass:"menuitem",class:{active:t.item.active}},[A("span",{class:t.item.icon}),t._v(" "),t.item.text&&t.item.longtext?A("p",[A("strong",{staticClass:"menuitem-text"},[t._v("\n\t\t\t\t"+t._s(t.item.text)+"\n\t\t\t")]),A("br"),t._v(" "),A("span",{staticClass:"menuitem-text-detail"},[t._v("\n\t\t\t\t"+t._s(t.item.longtext)+"\n\t\t\t")])]):t.item.text?A("span",[t._v("\n\t\t\t"+t._s(t.item.text)+"\n\t\t")]):t.item.longtext?A("p",[t._v("\n\t\t\t"+t._s(t.item.longtext)+"\n\t\t")]):t._e()])])}),[],!1,null,"febed9b6",null).exports},props:{menu:{type:Array,default:function(){return[{href:"https://nextcloud.com",icon:"icon-links",text:"Nextcloud"}]},required:!0}}},u=A(55),g={insert:"head",singleton:!1},p=(o()(u.a,g),u.a.locals,A(56)),f=A.n(p),m=Object(l.a)(d,(function(){var t=this.$createElement,n=this._self._c||t;return n("ul",{staticClass:"popover__menu"},this._l(this.menu,(function(t,A){return n("PopoverMenuItem",{key:A,attrs:{item:t}})})),1)}),[],!1,null,"4dae360a",null);"function"==typeof f.a&&f()(m);var C=m.exports;
/**
 * @copyright Copyright (c) 2018 John Molakvoæ <skjnldsv@protonmail.com>
 *
 * @author John Molakvoæ <skjnldsv@protonmail.com>
 ...
 * along with this program. If not, see <http://www.gnu.org/licenses/>.
 *
 */n.default=f},,,,function(t,n){t.exports=require("core-js/modules/es.string.from-code-point.js")},function(t,n){t.exports=require("core-js/modules/es.string.code-point-at.js")}])}));
